...
def get_DF(path, partitioning, file_name="final_result_S"):
    # layers = range(1, 20)
    ...
    for num_subgraphs in [5]:
        for train_ratio in [0.1]:
            ...
            for DGCN_layers in layers:
                file_path = f"{path}{partitioning}/{num_subgraphs}/{train_ratio}/{DGCN_layers}/{file_name}_{train_ratio}.csv"
...
if __name__ == "__main__":
    ...
    for partitioning in ["kmeans"]:
        ...
        df_S, final_path = get_DF(path, partitioning, file_name_S)
