...
def set_state_dict(model, state_dict, skip_stat=False, skip_mask=False):
    state_dict = convert_np_to_tensor(
        state_dict, skip_stat=skip_stat, skip_mask=skip_mask, model=model.state_dict()
    )
